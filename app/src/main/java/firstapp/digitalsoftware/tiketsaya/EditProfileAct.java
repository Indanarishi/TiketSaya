...
public class EditProfileAct extends AppCompatActivity {
    ...
    EditText xnama_lengkap, xbio, xpassword, xusername, xemail_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Picasso.with(EditProfileAct.this).load(snapshot.child("url_photo_profile").getValue().toString()).centerCrop().fit().into(photo_edit_profile);
            }
